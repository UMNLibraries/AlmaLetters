        ...
        <div class="messageArea">
          <div class="messageBody">
            <table role='presentation'  cellspacing="0" cellpadding="5" border="0">
				...
				<xsl:if test="(notification_data/incoming_request/due_date !='') and ($isEbook='true')">
					<tr>
						<td>@@due_date@@:<xsl:value-of select="notification_data/incoming_request/due_date"/> </td>
					</tr>
				</xsl:if>
