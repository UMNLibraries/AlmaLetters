        ...
        <div class="messageArea"> 
          <div class="messageBody"> 
            ...
            <table role="presentation" cellspacing="0" cellpadding="5" border="0"> 
              ...
              <tr> 
                <td><strong>@@title@@:&#160;</strong><xsl:value-of select="notification_data/phys_item_display/title"/></td> 
              </tr> 

              <xsl:if test="notification_data/terms_of_use != ''"> 
                <tr> 
                  <td><strong>@@terms_of_use@@:&#160;</strong><xsl:value-of select="notification_data/terms_of_use"/></td> 
                </tr> 
              </xsl:if> 
              ...
              <xsl:if test="notification_data/download_url_saml != ''"> 
                <tr> 
                  <td>
                    @@for_saml_users@@&#160;<a href="{notification_data/download_url_saml}" target="_blank">@@click_here@@</a>
                  </td> 
                </tr> 
              </xsl:if>     
              ...
              <xsl:if test="notification_data/download_url_local != ''"> 
                <tr> 
                  <td>
                    @@for_local_users@@&#160;<a href="{notification_data/download_url_local}" target="_blank">@@click_here@@</a>
                  </td> 
                </tr> 
              </xsl:if> 
              ...
              <!-- Help & Access Notice Section --> 
              <tr> 
                <td>
                  You may also find your digital copy in your <a href="http://www.lib.umn.edu/systemlibraries" target="_blank">My Account</a>. 
                  If you are unable to use this PDF in its current format or if you have any additional questions about your request, <a href="http://www.lib.umn.edu/ill-system-libraries" target="_blank">please contact us at your campus library</a> so that we can assist you further.
                </td>     
              </tr> 
