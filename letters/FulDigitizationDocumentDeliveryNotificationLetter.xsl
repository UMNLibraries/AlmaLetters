...
-->        
	...
	<tr>
				    <td>You may also find your digital copy in your <a href="http://www.lib.umn.edu/systemlibraries">my account</a>.  
				    If you are unable to use this PDF in its current format or if you have any additional questions about your request, <a href="http://www.lib.umn.edu/ill-system-libraries">please contact us at your campus library</a>. so that we can assist you further.</td>    
				</tr>
<!-- end added section -->
