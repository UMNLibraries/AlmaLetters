                ...
                <div class="messageArea">
                    <div class="messageBody">
                        <table cellspacing="0" cellpadding="5" border="0">
                            <xsl:choose>
                                <xsl:when
                                    test="/notification_data/phys_item_display/available_items/available_item/location_code = 'UMDIL'">
                                    <tr>
                                        <td>Your Interlibrary Loan request for the following title has been received. Please allow one hour for Interlibrary Loan staff to process the item before coming to the Martin Library circulation desk for pickup.
                                     </td>
                                    </tr>
                                    <tr>
                                    </tr>
                                    <br/>
                                    <tr>
                                        <td>If you requested this item be delivered to your faculty office address, please expect the item to arrive in 2-3 working days.
                                     </td>
                                    </tr>
