				...
				<div class="messageBody">
					 <table cellspacing="0" cellpadding="5" border="0">
			          ...
			          <tr>
						...
						<tr>
							<td>
								<b>ALLOW OTHER FORMAT: </b>
								<xsl:value-of select="notification_data/incoming_request/allow_other_format"/>
							</td>
						</tr>
						...
						<xsl:if  test="notification_data/metadata/additional_title != ''" >
							<tr>
								<td>
									<b>ADDITIONAL TITLE: </b>
									<xsl:value-of select="notification_data/metadata/additional_title"/>
								</td>
							</tr>
						</xsl:if>
