...
<td style="padding:0 0 5px 10px;">
							...
							<tr>
								<td style="padding:0 0 5px 10px;">
										@@share_with_students@@<br/><br/>
Please contact <a href="mailto:coursematerials@umn.edu">coursematerials@umn.edu</a> for assistance or submit your reading list using the <a href="http://z.umn.edu/coursematerialrequest">Course Materials request form</a>.
@@latest_date_submission@@
										 @@ensure_access@@
										You can also learn how to manage your own list by visiting the <a href="https://libguides.umn.edu/library-course-materials">Library Course Materials guide </a>. <br/>
