	...
	<xsl:template match="/">
		...
		<body style = "padding: 0; font-family: Source Sans Pro,Helvetica Neue,Helvetica,Arial,sans-serif;">
			<table cellpadding="0" cellspacing="0" style="margin: auto; width: 600px;">
				<tr>
					<td style="background-color: #7a0019; border-top-left-radius: 15px; border-top-right-radius: 15px;">
						<img alt="The library Logo" style="height: 35px; padding: .85em;">
				...
				<tr>
					<td style="background-color: #7a0019; padding: 0 15px; color: #fff; box-shadow: inset 0 3px 10px -2px rgba(0,0,0,0.3)">
						...
						<h3 style="font-size: 1rem; margin: 0 0 30px 0; font-weight: normal;">
							...
							<a style="font-style: italic; text-decoration: none; color: #ffcc33;">
				...
				<tr>
					<td style="background-color: #7a0019; text-align:center; padding: 15px">
							<a style="color: #fff">
								<xsl:attribute name="href">
