				...
				<div class="messageBody">
					 <table cellspacing="0" cellpadding="5" border="0">
						...
						<xsl:if  test="notification_data/alternate_symbol != ''" >
							<tr>
								<td>
									<strong><h1><xsl:value-of select="notification_data/alternate_symbol"/></h1></strong>
								</td>
							</tr>
						</xsl:if>
			            ...
			            <xsl:for-each select="notification_data/partner_shipping_info_list/partner_shipping_info">
							<table cellspacing="0" cellpadding="5" border="0">
								...
								<xsl:if test="/notification_data/partner_shipping_info_list/partner_shipping_info/address1!=''">
								...
								<xsl:if test="/notification_data/partner_shipping_info_list/partner_shipping_info/address3!=''">
								...
								<tr><td><xsl:value-of select="address5"/></td></tr>
									...
									<tr><td><xsl:value-of select="city"/>&#160;<xsl:value-of select="state"/>&#160;<xsl:value-of select="postal_code"/></td></tr>
