          ...
          <div class="messageBody">
            <table cellspacing="0" cellpadding="5" border="0">
				<tr>
					...
					<br />
					<br />
					<b>@@title@@: </b><xsl:value-of select="notification_data/line/item_description" />
					<br />
					<b>@@order_number@@: </b><xsl:value-of select="notification_data/line/reference_number" />
					<br />
                                        <b>Vendor Reference Number: </b><xsl:value-of select="notification_data/line/vendor_reference_number" />
					<br />
                                        <b>Note to Vendor: </b><xsl:value-of select="notification_data/line/vendor_note" />
					<br />
